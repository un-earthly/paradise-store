            ...
            <div className="container">
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4">
                        <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-base-300 py-16 px-10 text-center sm:px-12 md:px-[60px]">
                            <div className="mb-10 text-center md:mb-16">
                                <h1 className='text-3xl font-bold'>Sign Up</h1>
                            </div>
                            <form onSubmit={e => handleSubmit(e)} className='space-y-5 mb-10'>
                                <input
                                    type="text"
                            ...
                            <ul className="-mx-2 mb-8 flex justify-between">
                                ...
                                <li className="w-full px-2">
                                    <span className="flex h-11 items-center justify-center rounded-md bg-[#D64937] hover:bg-opacity-90">
                            ...
                            <div className="text-base">
                                Already a member?<span className="btn-link"><Link href="/login">Sign In.</Link></span>
                            </div>
